insert into user(username, first_name, last_name, email, role, active) values ('USER_1', 'FIRST_NAME_1', 'LAST_NAME_1', 'EMAIL_1', 'ROLE_1', true)
...
insert into user(username, first_name, last_name, email, role, active) values ('USER_5', 'FIRST_NAME_5', 'LAST_NAME_2', 'EMAIL_5', 'ROLE_2', true)
insert into user(username, first_name, last_name, email, role, active) values ('USER_6', 'FIRST_NAME_1', 'LAST_NAME_6', 'EMAIL_6', 'ROLE_1', true)
